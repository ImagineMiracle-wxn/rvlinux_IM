...
#define VIRTNET_NAME  "u500_virt_eth0"
#define DRV_VISION    "v0.1"
...
{
    printk(KERN_NOTICE "virt_start_xmit\n");
...
static const struct net_device_ops u500_net_ops = {
...
static int virt_net_init(void)
{
    ...
    virt_net = alloc_netdev(sizeof(u500_virnet_info), "virt_eth0", NET_NAME_UNKNOWN, ether_setup);

    /*2)设置net_device结构体的成员 */
    virt_net->netdev_ops       = &u500_net_ops;
    ...
    virt_net->features        |= NETIF_F_IP_CSUM;

    db = netdev_priv(virt_net);
