...
#define TASK_THREAD_RA 1464 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 1472 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 1480 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 1488 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 1496 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 1504 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 1512 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 1520 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 1528 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 1536 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 1544 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 1552 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 1560 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 1568 /* offsetof(struct task_struct, thread.s[11]) */
#define TASK_THREAD_SP 1472 /* offsetof(struct task_struct, thread.sp) */
...
#define TASK_THREAD_F0 1576 /* offsetof(struct task_struct, thread.fstate.f[0]) */
#define TASK_THREAD_F1 1584 /* offsetof(struct task_struct, thread.fstate.f[1]) */
#define TASK_THREAD_F2 1592 /* offsetof(struct task_struct, thread.fstate.f[2]) */
#define TASK_THREAD_F3 1600 /* offsetof(struct task_struct, thread.fstate.f[3]) */
#define TASK_THREAD_F4 1608 /* offsetof(struct task_struct, thread.fstate.f[4]) */
#define TASK_THREAD_F5 1616 /* offsetof(struct task_struct, thread.fstate.f[5]) */
#define TASK_THREAD_F6 1624 /* offsetof(struct task_struct, thread.fstate.f[6]) */
#define TASK_THREAD_F7 1632 /* offsetof(struct task_struct, thread.fstate.f[7]) */
#define TASK_THREAD_F8 1640 /* offsetof(struct task_struct, thread.fstate.f[8]) */
#define TASK_THREAD_F9 1648 /* offsetof(struct task_struct, thread.fstate.f[9]) */
#define TASK_THREAD_F10 1656 /* offsetof(struct task_struct, thread.fstate.f[10]) */
#define TASK_THREAD_F11 1664 /* offsetof(struct task_struct, thread.fstate.f[11]) */
#define TASK_THREAD_F12 1672 /* offsetof(struct task_struct, thread.fstate.f[12]) */
#define TASK_THREAD_F13 1680 /* offsetof(struct task_struct, thread.fstate.f[13]) */
#define TASK_THREAD_F14 1688 /* offsetof(struct task_struct, thread.fstate.f[14]) */
#define TASK_THREAD_F15 1696 /* offsetof(struct task_struct, thread.fstate.f[15]) */
#define TASK_THREAD_F16 1704 /* offsetof(struct task_struct, thread.fstate.f[16]) */
#define TASK_THREAD_F17 1712 /* offsetof(struct task_struct, thread.fstate.f[17]) */
#define TASK_THREAD_F18 1720 /* offsetof(struct task_struct, thread.fstate.f[18]) */
#define TASK_THREAD_F19 1728 /* offsetof(struct task_struct, thread.fstate.f[19]) */
#define TASK_THREAD_F20 1736 /* offsetof(struct task_struct, thread.fstate.f[20]) */
#define TASK_THREAD_F21 1744 /* offsetof(struct task_struct, thread.fstate.f[21]) */
#define TASK_THREAD_F22 1752 /* offsetof(struct task_struct, thread.fstate.f[22]) */
#define TASK_THREAD_F23 1760 /* offsetof(struct task_struct, thread.fstate.f[23]) */
#define TASK_THREAD_F24 1768 /* offsetof(struct task_struct, thread.fstate.f[24]) */
#define TASK_THREAD_F25 1776 /* offsetof(struct task_struct, thread.fstate.f[25]) */
#define TASK_THREAD_F26 1784 /* offsetof(struct task_struct, thread.fstate.f[26]) */
#define TASK_THREAD_F27 1792 /* offsetof(struct task_struct, thread.fstate.f[27]) */
#define TASK_THREAD_F28 1800 /* offsetof(struct task_struct, thread.fstate.f[28]) */
#define TASK_THREAD_F29 1808 /* offsetof(struct task_struct, thread.fstate.f[29]) */
#define TASK_THREAD_F30 1816 /* offsetof(struct task_struct, thread.fstate.f[30]) */
#define TASK_THREAD_F31 1824 /* offsetof(struct task_struct, thread.fstate.f[31]) */
#define TASK_THREAD_FCSR 1832 /* offsetof(struct task_struct, thread.fstate.fcsr) */
...
#define ASM_THREAD_SIZE 8192 /* THREAD_SIZE */
